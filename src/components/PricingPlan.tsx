...
const PricingPlan = () => {
  return (
    <>
      <section className="py-20 dark:bg-transparent dark:text-gray-800">
          ...
          <div className="flex flex-wrap items-stretch mx-1">
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
                ...
                <button
                  type="button"
                  className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-primaryClr dark:text-gray-50"
                >
                  Get Started
                </button>
              </div>
            ...
            {/* card two */}
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-primaryClr dark:text-gray-50">
                <div className="space-y-2">
                ...
                <a
                  ...
                  href="#"
                  className="inline-block w-full px-5 py-3 font-bold tracking-wider text-center rounded bg-gray-100 dark:text-violet-600"
                >
                  Get Started
                </a>
              </div>
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded bg-primaryClr dark:text-gray-50"
                >
                  Get Started
                </a>
              </div>
