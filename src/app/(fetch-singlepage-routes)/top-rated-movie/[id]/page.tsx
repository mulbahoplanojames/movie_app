...
const handleTopRatedMovieFetch = async (id: string) => {
  const res = await fetch(
...
const TopRatedMoviePreview = async ({ params }: { params: { id: string } }) => {
  const result = await handleTopRatedMovieFetch(params.id);
